 ...
 *
 * `buildings` 전수 평균이라 지어낸 값이 아니다(관악 22,501건 · 임실 8,092건).
 * 실제 데이터가 있는 화면은 그 좌표로 다시 잡으므로 여기는 첫 프레임용이다.
 */
export const REGION_CENTER: Record<string, { lat: number; lng: number }> = {
  "11620": { lat: 37.479085, lng: 126.936807 }, // 관악구
  "52750": { lat: 35.594047, lng: 127.250127 }, // 임실군
};
